      ...
      <LeftParticleBackground />
        <div className="relative z-10 text-center px-6">
          ...
          <p className="mt-4 text-gray-300 max-w-sm mx-auto">
            Sign in to continue your journey with TalkRehearsel. Access your dashboard, projects, and learning space.
          </p>
        </div>
      </div>

      {/* Right: Sign In Form (matching Contact typography) */}
        ...
        >
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 48 48"
            >
              <path fill="#EA4335" d="M24 9.5c3.94 0 7.46 1.36 10.25 3.6l7.65-7.65C37.6 1.9 31.2 0 24 0 14.6 0 6.2 5.4 2.5 13.3l8.9 6.9C13.6 14.1 18.4 9.5 24 9.5z"/>
              <path fill="#4285F4" d="M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v9h12.7c-.6 3-2.4 5.6-5.1 7.3l7.9 6.1c4.6-4.2 7-10.4 7-17.9z"/>
              <path fill="#FBBC05" d="M11.4 28.2c-1-2.9-1-6.1 0-9l-8.9-6.9C.9 15.6 0 19.7 0 24s.9 8.4 2.5 11.7l8.9-7.5z"/>
              <path fill="#34A853" d="M24 48c6.5 0 12-2.1 16-5.7l-7.9-6.1c-2.2 1.5-5 2.4-8.1 2.4-5.6 0-10.4-3.8-12.1-9l-8.9 7.5C6.2 42.6 14.6 48 24 48z"/>
            </svg>
